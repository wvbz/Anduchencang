		...
		<!-- container -->
			...
			<%
                 ...
                 String pro_info = (String) request.getParameter("pro_info");
                    		...
                    		%>
                  <form action="ProjectNowServlet?pro_id=<%=pro_id %>" method="post">
				<
					...
					<div id="owl-demo1" class="owl-carousel owl-carousel2">
					                <div class="item">
					                	<div class="about-left-grid">
											...
											<p><%=pro_intro %></p>
											<ul>
												<li><a class="a-btn-a scroll" href="#port">结束项目</a></li>
											</ul>
										</div>
					                </div>
						           <div class="item">
						            ...
						            <div class="item">
					                	<div class="about-left-grid">
											...
											<ul>
                                                ...
                                                <li><a class="a-btn-a scroll" href="#port">发布培训</a></li>
											</ul>
										</div>
					                </div>
                                   <div class="item">
					                	<div class="about-left-grid">
											<h2>志愿者管理</h2>
											<ul>
												<li><a class="a-btn-a scroll" href="#port">志愿者管理</a></li>
											</ul>
										</div>
					                </div>
